...
mixin _$ConfigModel {
  ...
  int? get numberPictograms => throw _privateConstructorUsedError;
...
abstract class $ConfigModelCopyWith<$Res> {
  ...
  $Res call({String? baseUrl, List<String>? languages, int? numberPictograms});
}
...
class _$ConfigModelCopyWithImpl<$Res> implements $ConfigModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? numberPictograms = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      languages: languages == freezed
          ...
          : languages // ignore: cast_nullable_to_non_nullable
              as List<String>?,
      numberPictograms: numberPictograms == freezed
          ? _value.numberPictograms
          : numberPictograms // ignore: cast_nullable_to_non_nullable
              as int?,
    ));
  }
}
...
class _$_ConfigModel with DiagnosticableTreeMixin implements _ConfigModel {
  const _$_ConfigModel(
      {this.baseUrl, final List<String>? languages, this.numberPictograms})
  ...
  @override
  final int? numberPictograms;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ConfigModel(baseUrl: $baseUrl, languages: $languages, numberPictograms: $numberPictograms)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('numberPictograms', numberPictograms));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.numberPictograms, numberPictograms));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(numberPictograms));
...
abstract class _ConfigModel implements ConfigModel {
  const factory _ConfigModel(
      ...
      final int? numberPictograms}) = _$_ConfigModel;
